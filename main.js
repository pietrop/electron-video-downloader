      ...
      submenu: [
        {
          label: 'Project Page',
          click() {
            require('electron').shell.openExternal('https://github.com/pietrop/electron-video-downloader');
          },
        },
        {
          label: 'Raise an issue',
          click() {
            require('electron').shell.openExternal('https://github.com/pietrop/electron-video-downloader/issues');
          },
        },
      ],
    },
